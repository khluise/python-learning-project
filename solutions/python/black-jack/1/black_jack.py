...
def value_of_ace(card_one, card_two):
    ...
    """
    ace_in_hand_correction = 0
    
    if 'A' in (card_one, card_two):
        ace_in_hand_correction = 10    # because value_of_card(card) use 'A' = 1,
                                       # but we need A = '11' here.
    
    hand_value = value_of_card(card_one) + value_of_card(card_two) \
                 + ace_in_hand_correction
...
def is_blackjack(card_one, card_two):
    ...
    return has_ace and total_value == 11
