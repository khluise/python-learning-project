...
def reactor_efficiency(voltage, current, theoretical_max_power):
    ...
    if power_efficiency < 30:
        return 'black'
    elif power_efficiency <60:
        return 'red'
    elif power_efficiency <80:
        return 'orange'
...
def fail_safe(temperature, neutrons_produced_per_second, threshold):
    ...
    """
    criticality_percentage = 100 * temperature * neutrons_produced_per_second / threshold 

    if criticality_percentage < 90:
        return 'LOW'
    elif abs(criticality_percentage - 100) <= 10:
        return 'NORMAL'
